...
<x-headerfooter>
    @section('maintitle', 'Privacy Policy')
    <main class="flex-grow container mx-auto max-w-3xl px-4 py-12">
        {{-- Hero Section --}}
        <header class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Privacy Policy</h1>
            <p class="text-gray-600">Last updated: <span class="font-medium">May 31, 2025</span></p>
        </header>
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Interpretation and Definitions</h2>

            <div class="mb-6">
                <h3 class="text-xl font-medium text-gray-800 mb-2">Interpretation</h3>
            ...
            <div>
                <h3 class="text-xl font-medium text-gray-800 mb-2">Definitions</h3>
                ...
                <ul class="list-disc list-inside space-y-3 text-gray-700 leading-relaxed">
                    ...
                    <li>
                        ...
                        Agreement) refers to CloudPractitionerHelp.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Website</strong> refers to CloudPractitionerHelp, accessible from
                        <a href="https://www.cloudpractitionerhelp.com/" target="_blank"
                            class="text-blue-600 hover:underline">
                            https://www.cloudpractitionerhelp.com/
                        </a>
                    </li>
                    <li>
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Collecting and Using Your Personal Data</h2>

            <div class="mb-6">
                <h3 class="text-xl font-medium text-gray-800 mb-2">Types of Data Collected</h3>

                <div class="mb-4">
                    <h4 class="text-lg font-medium text-gray-800 mb-2">Personal Data</h4>
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-800 mb-2">Usage Data</h4>
                    <p class="text-gray-700 leading-relaxed mb-3">
            ...
            <div class="mb-6">
                <h4 class="text-lg font-medium text-gray-800 mb-2">Information from Third-Party Social Media Services
                </h4>
                <p class="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
                <h4 class="text-lg font-medium text-gray-800 mb-2">Tracking Technologies and Cookies</h4>
                <p class="text-gray-700 leading-relaxed mb-3">
                ...
                <ul class="space-y-6 text-gray-700 mb-4">
                    <li>
                ...
                <ul class="space-y-6 text-gray-700">
                    <li>
                        ...
                        <span class="text-gray-600">Type:</span> Session Cookies<br>
                        <span class="text-gray-600">Administered by:</span> Us<br>
                        <span class="text-gray-600">Purpose:</span> These Cookies are essential to provide You with
                        services available through the Website and to enable You to use some of its features. They help
                        to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the
                    ...
                    <li>
                        ...
                        <span class="text-gray-600">Type:</span> Persistent Cookies<br>
                        <span class="text-gray-600">Administered by:</span> Us<br>
                        <span class="text-gray-600">Purpose:</span> These Cookies identify if users have accepted the
                    ...
                    <li>
                        ...
                        <span class="text-gray-600">Type:</span> Persistent Cookies<br>
                        <span class="text-gray-600">Administered by:</span> Us<br>
                        <span class="text-gray-600">Purpose:</span> These Cookies allow us to remember choices You make
                        when You use the Website, such as remembering your login details or language preference. The
        ...
        <section class="mb-10">
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Use of Your Personal Data</h3>
            <p class="text-gray-700 leading-relaxed mb-4">
                The Company may use Personal Data for the following purposes:
            </p>
            <ul class="list-disc list-inside space-y-3 text-gray-700 leading-relaxed mb-6">
                <li>
        ...
        <section class="mb-10">
            <h3 class="text-xl font-medium text-gray-800 mb-4">Retention of Your Personal Data</h3>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h3 class="text-xl font-medium text-gray-800 mb-4">Transfer of Your Personal Data</h3>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h3 class="text-xl font-medium text-gray-800 mb-4">Delete Your Personal Data</h3>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Disclosure of Your Personal Data</h3>

            <div class="mb-6">
                <h4 class="text-lg font-medium text-gray-800 mb-2">Business Transactions</h4>
                <p class="text-gray-700 leading-relaxed">
            ...
            <div class="mb-6">
                <h4 class="text-lg font-medium text-gray-800 mb-2">Law enforcement</h4>
                <p class="text-gray-700 leading-relaxed">
            ...
            <div>
                <h4 class="text-lg font-medium text-gray-800 mb-2">Other legal requirements</h4>
                <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Security of Your Personal Data</h2>
            <p class="text-gray-700 leading-relaxed">
        ...
        {{-- Children’s Privacy --}}
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Children’s Privacy</h2>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Links to Other Websites</h2>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Changes to this Privacy Policy</h2>
            <p class="text-gray-700 leading-relaxed mb-3">
        ...
        <section class="mb-12">
            ...
            <ul class="space-y-2 text-gray-700 leading-relaxed">
                <li><strong>By email:</strong> <a href="mailto:anirudh1997@hotmail.com"
                        class="text-blue-600 hover:underline">anirudh1997@hotmail.com</a></li>
                <li>
